...
if game.PlaceId == 11765695364 then
    ...
    --Misc
    MiscSection:NewButton("ServerHop", "Changes Servers for you", function()
        game:GetService("TeleportService"):Teleport(11765695364, game:GetService("Players").LocalPlayer)
    end)

    MiscSection:NewButton("Rejoin", "Rejoins The same server for you", function()
